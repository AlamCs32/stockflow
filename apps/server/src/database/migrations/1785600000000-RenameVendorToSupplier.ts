...
export class RenameVendorToSupplier1785600000000 implements MigrationInterface {
  name = 'RenameVendorToSupplier1785600000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "suppliers" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "code" text NOT NULL, "name" text NOT NULL, "contact_email" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_suppliers_code" UNIQUE ("code"), CONSTRAINT "PK_suppliers" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "designs" ("id" SERIAL NOT NULL, "design_code" text NOT NULL, "pattern_code" text NOT NULL, "name" text NOT NULL, "supplier_id" uuid NOT NULL, "category_id" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_designs_design_code" UNIQUE ("design_code"), CONSTRAINT "PK_designs" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(`CREATE INDEX "IDX_designs_supplier_id" ON "designs" ("supplier_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_designs_category_id" ON "designs" ("category_id")`);
    await queryRunner.query(
      `ALTER TABLE "designs" ADD CONSTRAINT "FK_designs_supplier_id" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "channel_pricings" ("id" SERIAL NOT NULL, "channel_name" text NOT NULL, "selling_price" double precision NOT NULL, "margin" double precision NOT NULL, "variant_id" integer NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_channel_pricings_variant_channel" UNIQUE ("variant_id", "channel_name"), CONSTRAINT "PK_channel_pricings" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "stock_logs" ("id" SERIAL NOT NULL, "variant_id" integer NOT NULL, "quantity_change" integer NOT NULL, "reason" text NOT NULL, "channel" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_stock_logs" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
